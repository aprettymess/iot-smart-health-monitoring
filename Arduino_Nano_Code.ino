...
String apiKey = "6ZXNAJ2QMRMFM0XV";
...
void setup()
{
    ...
    Serial.begin();            // we agree to talk fast!
    ...
    String cmd = "AT+CWJAP=\"RamishHome\",\"98765432\"";
    ser.println(cmd);
    delay(1000);
...
void esp_8266()
{
    // TCP connection AT+CIPSTART=4,"TCP","api.thingspeak.com",80
    ...
    String getStr = "GET /channels/2792922/feeds.json?api_key=";
    getStr += apiKey;
    getStr += "&results=100";
    getStr += "\r\n\r\n";
    // send data length
